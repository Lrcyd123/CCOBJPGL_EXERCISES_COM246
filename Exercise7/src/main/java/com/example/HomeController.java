...
public class HomeController implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle rb){
      ...
      statuschoicebox.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
    ...
    private void loadData(){
        ...
        try {
            ...
            if (myFile.exists()) {
                ...
                statuschoicebox.setItems(mylist);
    ...
    public boolean deleteuser(ActionEvent event) {
        ...
        User user = homelabel.getSelectionModel().getSelectedItem();
    ...
    public boolean updateuser(ActionEvent event) {
        ...
        String status = homelabel.getValue();
